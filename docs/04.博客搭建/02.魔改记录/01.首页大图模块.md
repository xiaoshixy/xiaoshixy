---
title: 首页大图模块
date: 2022-06-24 08:43:58
permalink: /pages/1e8897/
categories:
  - 博客搭建
  - 魔改记录
tags:
...
具体样式首页可见，[点击跳转](https://notes.youngkbt.cn/)

![微信截图_20220624094129](https://cdn.jsdelivr.net/gh/xiayuan-001/picx-image-hosting@main/vueblog/微信截图_20220624094129.1roge0865tog.webp)
...
如果 `bodyBgImg` 是数组，则每隔 15 秒切换一次图片，具体介绍请看官网，[点击直达 (opens new window)](https://doc.xugaoyi.com/pages/a20ce8/#bodybgimg)。
...
上面的所有配置是属于 **静态大图效果**，如果你喜欢我的 **动态** 首页背景图：全背景、颜色随时间变化、日历显示当天、时间同步当前、播放音乐有音谱 ...

### 静态资源获取

首先需要下载一些需要用到的图片，总共 1.47MB。[点击前往下载地址 ](https://www.youngkbt.cn/download/light/网站源码/)，找到 `fantasy.rar` 压缩包并下载。

下载后将其解压到 public 目录下，解压后的文件夹叫 `fantasy`，不是请改名。如图：

![微信截图_20220624095607](https://cdn.jsdelivr.net/gh/xiayuan-001/picx-image-hosting@main/vueblog/微信截图_20220624095607.74z06c9r7ds0.webp)
